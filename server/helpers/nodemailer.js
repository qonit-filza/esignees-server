                                                                  ...
                                                                  <td width="570" class="esd-container-frame" align="center" valign="top">
                                                                      <table cellpadding="0" cellspacing="0" width="100%">
                                                                          <tbody>
                                                                              ...
                                                                              <tr>
                                                                                  <td align="center" class="esd-block-text es-p30t es-m-txt-c">
                                                                                      <h1 style="font-family: tahoma, verdana, segoe, sans-serif;"><span style="font-size: 25px;">Dear ${nameSender},<br>Your message already signed&nbsp;by ${nameReceiver}</span><span style="font-size: 26px;">.</span></h1>
                                                                                  </td>
                                                                              </tr>
                                                                          </tbody>
                                                                      </table>
                                                                  ...
                                                                  <td width="570" class="esd-container-frame" align="center" valign="top">
                                                                      <table cellpadding="0" cellspacing="0" width="100%">
                                                                          <tbody>
                                                                              ...
                                                                              <tr>
                                                                                  <td align="center" class="esd-block-text es-p30t es-m-txt-c">
                                                                                      <h1 style="font-family: tahoma, verdana, segoe, sans-serif;"><span style="font-size: 25px;">Dear ${nameSender},<br>Your message already rejected&nbsp;by ${nameReceiver}</span><span style="font-size: 26px;">.</span></h1>
                                                                                  </td>
                                                                              </tr>
                                                                          </tbody>
                                                                      </table>
